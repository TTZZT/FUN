...
<head>
    {{-- <title> - Bootstrap 5 Admin Dashboard Template For DevePortallopers</title> --}}
    ...
    <!-- FontAwesome JS-->
    <script defer src="assetss/plugins/fontawesome/js/all.min.js"></script>

    <!-- App CSS -->
    <link id="theme-style" rel="stylesheet" href="assetss/css/portal.css">
                        ...
                        <div class="app-utilities col-auto">
                                            ...
                                            <div class="row gx-2 justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    <img class="profile-image"
                                                        src="assetss/images/profiles/profile-2.png" alt="">
                                                </div><!--//col-->
                                                <div class="col">
                                                    <div class="info">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown"
                                    ...
                                    <img src="assetss/images/user.png" alt="user profile">
                                </a>
